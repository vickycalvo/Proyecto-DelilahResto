...
INSERT INTO `users`
  (`id`, `username`,`password`,`fullName`,`email`,`adress`,`phoneNumber`,`isAdmin`)
VALUE
...
#CARGA TABLA ORDERS
INSERT INTO `orders`
  (`id`, `id_user`,`state`,`createdAt`,`description`, `paymentMethod`, `paymentValue`, `updatedAt`)
VALUE
  (1, 1, 'nuevo', '2007-05-10 00:00:00', '3 hamburguesas - 2 panchos', 'efectivo', 1000, '2007-05-10 00:00:00'),
  (2, 1, 'nuevo', '2007-05-10 00:00:00', '5 gaseosas', 'tarjeta', 750, '2007-05-10 00:00:00'),
  (3, 2, 'nuevo', '2007-05-10 00:00:00', '1 gaseosa- 1 hamburgesa - 1 pancho', 'tarjeta', 500, '2007-05-10 00:00:00');
